...
#         self.print_network()
    ...
    def feed_image_name(self, image_name,data_name):
    ...
    def optimize_parameters(self, step):
        ...
        #######################################################
        #######################################################
        LR_input = self.var_L               # LR_input=[2,3,128,128] 

        #######################################################
        #######################################################
        #######################################################   
        
        self.fake_H = self.netG(LR_input,self.image_name, self.data_name)
        ...
        if self.loss_type == 'fs':
            ...
            l1 = self.l_pix_w * self.l1_loss(self.fake_H, self.real_H)
            l2 = self.l_pix_w * self.l2_loss(self.fake_H, self.real_H)
            l_pix = l1 + l2

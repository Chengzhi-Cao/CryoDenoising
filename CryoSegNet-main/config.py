...
parser.add_argument("--test_dataset_path", type=str, default="/data/chengzhicao/CryoSegNet/test_dataset", help="Path to the test dataset")
parser.add_argument("--my_dataset_path", type=str, default="my_dataset", help="Path to your own dataset")
parser.add_argument("--output_path", type=str, default="/data/chengzhicao/CryoSegNet/output", help="Output directory")
...
# Model related arguments
parser.add_argument("--cryosegnet_checkpoint", type=str, default="/data/chengzhicao/CryoSegNet/pretrained_model/cryosegnet.pth", help="Path to CryoSegNet checkpoint")
parser.add_argument("--sam_checkpoint", type=str, default="/data/chengzhicao/CryoSegNet/pretrained_model/sam_vit_h_4b8939.pth", help="Path to SAM checkpoint")
